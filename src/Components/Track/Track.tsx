...
const Track: React.FC<TrackProps> = ({ title, artist, id, onClick, buttonSymb, album, image,preview_url }) => {
    ...
    return (
        <div className={styles.wrapper}>
            <div className={styles.preview}>
                ...
                <div className={styles.icon}>{!isPlaying ? <img onClick={handleImageClick} src={playIcon}/> : <img onClick={handleImageClick} src={stopIcon}/>}</div>
